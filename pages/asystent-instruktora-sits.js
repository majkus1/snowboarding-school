  ...
  return (
    ...
    {/* <Popup /> */}
      <Head>
        ...
        <meta
          name="description"
          content="Dołącz do społeczności instruktorów snowboardu. Kurs Asystenta Instruktora SITS w Pow Pow Riders to Twój start na drodze do zdobycia najlepszego zawodu na ziemi."
        />
      </Head>
      <Nav />
                  ...
                  {sectionIndex3 === 0 && (
                    <div className="buttons-to-slider">
                      ...
                      <div className="right-btn">
                        <button
                          onClick={handleRightArrowClick3}
                          aria-label="przesuń"
                        >
                          <AiOutlineRight />
                        </button>
                    ...
                    {sectionIndex3 === 1 && (
                      <div className="description-programms">
                        <p className="description-programms-txt">
                          ...
                          stopnia SITS);<br></br>– prezentuje umiejętności jazdy
                          na snowboardzie zgodnie z realizowanymi w Polsce
                          programami nauczania n poziomie II stopnia SITS;
                          <br></br>– przygotowuje konspekty zajęć, objaśnia
                          ćwiczenia i naucza zgodnie z zasadami bezpieczeństwa i
                          ochrony zdrowia, stosując zasady teorii i metodyki
                          sportu dla wszystkich oraz wykorzystując narzędzia
                          komunikacji i motywacji;<br></br>– monitoruje technikę
                          jazdy i sposób wykonywania ćwiczeń przez uczestników;
                          ...
                          <br></br>– prowadzić własną działalność gospodarczą w
                          zakresie nauczania i doskonalenia jazdy na
                          ...
                          uzyskiwać kwalifikacje związane z prowadzeniem procesu
                          dydaktycznego oraz treningowego w snowboardzie. Może
                          również zdobywać kwalifikacje związane z prowadzeniem
                          zajęć z innych, pokrewnych dyscyplin (np.
                          narciarstwo).
                          <br></br>
                          <br></br>
                          <strong>
                          ...
                          uprawiania snowboardu.<br></br>- ma konto użytkownika
                          na portalu SITS<br></br>- posiada ubezpieczenie NNW na
                          czas kursu
                          <br></br>
                          <br></br>
                          Po zdanym egzaminie, aby uzyskać legitymacje ASYSTENTA
                          INSTRUKTORA SITS, osoba musi przedłożyć AKTUALNE
                          zaświadczenie, że nie była skazana prawomocnym
                          wyrokiem za umyślne przestępstwo, o którym mowa w art.
                          46–50, lub określone w rozdziale XIX, XXIII, z
                          wyjątkiem art. 192 i art. 193, rozdziale XXV i XXVI
                          ustawy z dnia 6 czerwca 1997 r. – Kodeks karny (Dz. U.
                          z 2016 r. poz. 1137, z późn. zm.);<br></br>
                          <br></br>
                          <strong>Ważność stopnia:</strong>
                          <br></br>
                          Certyfikat ważny jest 3 lata.<br></br>
                          Warunkiem przedłużenia certyfikatu jest zaliczenie 1
                          dniowej unifikacji, organizowanej przez Licencjonowane
                          Szkoły Snowboardu SITS.
                        </p>
                      </div>
                    )}
                    {sectionIndex3 === 2 && (
